...
var chiffre = '0'
chiffre++
if(chiffre == '1') { console.log('Le fichier ici: '.error+'./Page web/anim/index.html'.warn + ' n\'éxiste pas'.error);
oui(); /* Function oui */ res.redirect('/notexist') //redirection
setTimeout(function(){ non() /*Function*/ },50)/* Timeout au cas ou*/  }/*Pour pas que il le fasse plein de fois */   
}; /*else exist */ });   //fs ecist
...
app.get('/jquery', function(req, res) { //chargement js
  ...
  var chiffre = '0'
  chiffre++
  if(chiffre == '1') { console.log('Le fichier ici: '.error+'./Page web/accueil/index.html'.warn + ' n\'éxiste pas'.error);
  oui(); /* Function oui */ res.redirect('/notexist') //redirection
  setTimeout(function(){ non() /*Function non*/ },50)/* Timeout au cas ou*/  }/*Pour pas que il le fasse plein de fois */   
  }; /*else exist */ });   //fs ecist
   });
